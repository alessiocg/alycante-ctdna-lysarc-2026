...
function buildMethodsTable() {
  const cellBorder = { style: BorderStyle.SINGLE, size: 1, color: 'BFBFBF' };
  const cellBorders = { top: cellBorder, bottom: cellBorder, left: cellBorder, right: cellBorder };
  const headers = ['Methode', 'Approche', 'LoD', 'Biopsie ?', 'Avantages', 'Limites', 'Etudes représentatives'];
  ...
  const rows = [
    ...
    ['CAPP-Seq', 'Panel cible récurrent + UMI deep sequencing', '~1-10 ppm', 'Non', 'Tumor-naive, génotypage simultane', 'Cout, expertise bioinfo', 'Scherer 2016 [3], Kurtz 2018 [5], Alig 2021 [21], Moia 2025 [68]'],
    ['PhasED-Seq', 'Variants phases co-localises (réduction bruit fond)', '~0.7 ppm', 'Recommandee', 'Sensibilite ultra-élevée, ideal MRD', 'Cout élevé', 'Kurtz 2021 [26], Klimova 2025 [71], Roschewski 2025 [75], Stepan 2026 [90]'],
    ['Signatera (mPCR)', 'Panel multiplex 16 SNV tumor-informed', '~1-10 ppm', 'Oui', 'Workflow commercial', 'Limite à 16 SNV', 'Narkhede 2024 [65]'],
    ...
    ['ULP-WGS cfDNA', 'WGS faible profondeur (CNV/burden)', 'TF >3%', 'Non', 'Faible cout, détecté CNV', 'Sensibilite limitée MRD', 'Zhao 2025 [74]'],
    ['ddPCR (single mut)', 'PCR digitale mutation spécifique', '~10^-3-10^-4', 'Oui', 'Cout faible, rapide', 'Une seule cible', 'Cas reports [72]'],
    ['Flow cytometry MRD', 'Phenotype B clonal résiduel', '~10^-4', 'Non (moelle)', 'Bien etabli leucemie aigue', 'Peu applicable DLBCL', 'Liu 2023 [54]'],
