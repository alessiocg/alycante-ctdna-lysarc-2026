...
setwd("C:/Users/4067048/AppData/Local/Temp/alycante_v2")

network <- paste0(
  "\\\\hmn-cifs-hnas.wprod.ds.aphp.fr\\shares\\",
  "IMMUNOLOGIE-BIOLOGIQUE\\SECTEUR MALADIES LYMPHOPROLIFERATIVES\\",
  "D_PROTOCOLES\\DLBCL\\protocole ALYCANTE\\R\u00e9union LYSARC 2026\\"
)

# ── Lecture Donnees.xlsx ──────────────────────────────────────────────────────
cat("=== Lecture Donnees.xlsx ===\n")
don <- read_excel(paste0(network, "Donnees.xlsx"), sheet = "Donnees")
...
rna <- read_excel(paste0(network, "ALYCANTE_RNASeq_21OCT2025.xlsx"), sheet = 1)
